...
const CourseDetails = () => {
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          ...
          <div className="ml-auto" id="accordionExample">
            <ul className="navbar-nav ml-auto position-relative" id="menu-center">
              ...
              <li className="nav-item nosublnk active">
                <a className="nav-link bidevices" href="#">About Us</a>
              </li>
              <li className="nav-item nosublnk active">
    ...
    <div className="container">
      ...
      <div className="coursedescps">
        <div className="iniinfos">
          <div className="row">
            <div className="col-6 col-lg-6 col-md-6">
              <div className="cicon"><img src="/images/timeic.png" /></div>
              <p>Duration</p>
              <p className="ogtxts">3 Years</p>
            </div>
            <div className="col-6 col-lg-6 col-md-6">
              <div className="cicon"><img src="/images/calenicon.png" /></div>
              <p>Start Date</p>
        ...
        <div className="crctsinf">
          <div className="row">
            <div className="col-6 col-lg-6 col-md-6">
              <a href="#" className="orangectathms nobrd">Apply Now</a>
            </div>
            <div className="col-6 col-lg-6 col-md-6">
              <a href="#" className="blackctathms nobrd"><img src="/images/downldico.png" />Brochure</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <section className="aboutsect innerprograms">
    <div className="container">
      <div className="col-md-12 col-lg-12 align-self-center text-center" data-aos="fade-up" data-aos-duration={1000}>
        <h2 className="mainhds mb-lg-4 ">Ab<div className="ogcl">o</div>ut Program</h2>
        <p>A Bachelor of Business Administration is one of the most sought-after and popular programs pursued by learners interested in the field of business management. The program opens doors to a plethora of job opportunities in numerous domains such as sales, marketing, education, finance, etc., to name a few. In the highly competitive business and marketing world, one needs to have strong leadership and managerial skills to have a flourishing career in the domain.</p>
        <p className="moretext2">BBA program offers knowledge and training in management and leadership skills to prepare the learners for managerial roles and entrepreneurship. The program will equip the learners with a clear understanding of various aspects of business administration, market trends and managerial decision making. Some of the significant job profiles that one can opt for after completing a BBA are Human Resource Executive, Marketing Executive, Marketing Manager, Sales Executive, Operations Executive and Finance Associate.</p>
        <a href="javascript:void(0);" className="moreless-button2">Read more </a>
      </div>
    </div>
  </section>
  <div className="stckds">
    <div className="mnptsd nofx">
      <div className="container">
        <ul>
          <li className="active"><a href="#specialization">About Specialization</a></li>
          {/* <li><a href="#highlights">Highlights</a></li> */}
          <li><a href="#eligiblity">Eligiblity</a></li>
          <li><a href="#syllabus">Syllabus</a></li>
          <li><a href="#feeplan">Fee Plan</a></li>
          <li><a href="#learnmethodology">Learning Methodology</a></li>
          <li><a href="#applynow">Enroll Now</a></li>
        </ul>
      </div>
    </div>
      ...
      <div className="bgrays" id="specialization">
        ...
        <div className="container">
          <div className="text-center hdingst  mt-5 mb-lg-4">
            <h2 className="mainhds">Ab<div className="ogcl">o</div>ut Specialization</h2>
          </div>
          <div className="mx-auto  col-md-12 col-lg-11 align-self-center text-center" data-aos="fade-up" data-aos-duration={1000}>
            <p>India is currently the third-largest aviation industry and is expected to be the largest by the year 2030, according to International Air Transport Association (IATA). To match the rapid growth in the aviation sector, there is an increasing demand for professionals with a broad knowledge of aviation management. Our BBA in Aviation Management is a stepping stone to getting into the aviation industry, equipping you with all the necessary knowledge about the industry and its various functions.</p>
            <p className="moretext"> Our program uses a unique blend of industry-relevant content on par with IATA standards resulting in an increased employability of our learners. This specialization offers a Choice Based Credit System, where the student has more expansive choices of electives to choose from based on their interests. The program provides the right blend of practical and theoretical knowledge with a strong emphasis on customer sensitivity, skills, and the holistic development of a learner.</p> 
    ...
    <section className="whtsects trustbycoms higlgtsdd" id="highlights">
      <div className="container">
        <div className="text-center hdingst">
          <h2 className="mainhds">Specializati<div className="ogcl">o</div>n Highlights</h2>
        </div>
      </div>	
        ...
        <div className="container">
          <div className="row lengtheds">
            <div className="col-md-6">
              ...
              <p>Be thoroughly equipped with the breadth of aircraft, airline, and airport operations courses</p>
            </div>
            <div className="col-md-6">
              <div className="lgocirc">
              </div>
              <p>Learn new age courses like Aviation Safety &amp; Security, Aviation Supply Chain, and Travel &amp; Tourism Management</p>
            </div>
            <div className="col-md-6">
              <div className="lgocirc">
              </div>
              <p>Gain business mastery with a unique blend of aviation and management courses</p>
            </div>
            <div className="col-md-6">
              <div className="lgocirc">
              </div>
              <p>Obtain in-depth knowledge of business and business processes of the aviation industry</p>
            </div>
            <div className="col-md-6">
              <div className="lgocirc">
              </div>
              <p>Be proficient in professional skills required to tackle challenges in aviation with the help of an industry-aligned curriculum.</p>
            </div>
          </div>
          <a href="javascript:void(0);" className="rdspecials">Read more </a>
        </div>
      </div>
    </section>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-6  whtsbga text-center">
            ...
            <p>Candidates who have passed Class 12th/PUC/HSC from any stream are eligible for Admission to BBA Programs.
              The candidate has to fulfill all the prescribed admission requirements/norms of the Institute / AICTE / UGC.</p>
          </div>
              ...
              <div id="accordion10">
                <div className="card">
                  <div className="card-header" id="headingOneSb">
                    <h5 className="mb-0">
                      <button className="btn btn-link" data-toggle="collapse" data-target="#collapseOneSb" aria-expanded="true" aria-controls="collapseOneSb">
                        Semester 1
                  ...
                  <div id="collapseOneSb" className="collapse show" aria-labelledby="headingOneSb" data-parent="#accordion10">
                ...
                <div className="card">
                  <div className="card-header" id="headingTwoSb">
                    <h5 className="mb-0">
                      <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwoSb" aria-expanded="false" aria-controls="collapseTwoSb">
                        Semester 2
                        <i className="fal fa-plus" />
                        <i className="fal fa-minus" />
                      </button>
                  ...
                  <div id="collapseTwoSb" className="collapse" aria-labelledby="headingTwoSb" data-parent="#accordion10">
                    <div className="card-body">
                      <ul>
                        <li>Lorem Ipsum is simply dummy text of the 
                          printing and typesetting </li>
                        <li>Lorem Ipsum is simply dummy text of the 
                          printing and typesetting </li>
                        <li>Lorem Ipsum is simply dummy text of the 
                          printing and typesetting </li>
                ...
                <div className="card">
                  <div className="card-header" id="headingThreeSb">
                    <h5 className="mb-0">
                      <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThreeSb" aria-expanded="false" aria-controls="collapseThreeSb">
                        Semester 3
                        <i className="fal fa-plus" />
                        <i className="fal fa-minus" />
                      </button>
                  ...
                  <div id="collapseThreeSb" className="collapse" aria-labelledby="headingThreeSb" data-parent="#accordion10">
                    <div className="card-body">
                      <ul>
                        <li>Lorem Ipsum is simply dummy text of the 
                          printing and typesetting </li>
                ...
                <div className="card">
                  <div className="card-header" id="headingFourSb">
                    <h5 className="mb-0">
                      <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFourSb" aria-expanded="false" aria-controls="collapseFourSb">
                        Semester 4
                        <i className="fal fa-plus" />
                        <i className="fal fa-minus" />
                      </button>
                  ...
                  <div id="collapseFourSb" className="collapse" aria-labelledby="headingFourSb" data-parent="#accordion10">
                    <div className="card-body">
                      <ul>
                        <li>Lorem Ipsum is simply dummy text of the 
                          printing and typesetting </li>
                ...
                <div className="card">
                  <div className="card-header" id="headingFiveSb">
                    <h5 className="mb-0">
                      <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFiveSb" aria-expanded="false" aria-controls="collapseFiveSb">
                        Semester 5
                        <i className="fal fa-plus" />
                        <i className="fal fa-minus" />
                      </button>
                  ...
                  <div id="collapseFiveSb" className="collapse" aria-labelledby="headingFiveSb" data-parent="#accordion10">
                    <div className="card-body">
                      <ul>
                        <li>Lorem Ipsum is simply dummy text of the 
                          printing and typesetting </li>
        ...
        <div className="planstabsdesn">
          <ul className="nav nav-tabs" id="myTab" role="tablist">
            <li className="nav-item">
              <a className="nav-link active" id="trending-tab" data-toggle="tab" href="#trending" role="tab" aria-controls="trending" aria-selected="true">National</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" id="allprofile-tab" data-toggle="tab" href="#allprofile" role="tab" aria-controls="allprofile" aria-selected="false">International</a>
            </li>
          </ul>
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <div className="deskverticals">
              <div id="owl_about_main_slider" className="owl-carousel owl-theme row">
                <div className="row">
                  <div className="col-6 col-lg-3">
                    <img src="/images/lm/LM1.png" />
                    <p>Each program involves approximately 120 hours of learning</p>
                  </div>
                  <div className="col-6 col-lg-3">
                  ...
                  <div className="col-6 col-lg-3">
                    ...
                    <p>Pre-recorded audio-video sessions available on the Learning Management System (LMS)</p>
                  </div>
                  <div className="col-6 col-lg-3">
                ...
                <div className="row">
                  <div className="col-6 col-lg-3">
                    ...
                    <p>Interactions through the discussion forum on the LMS</p>
                  </div>
                  <div className="col-6 col-lg-3">
                    <img src="/images/lm/LM6.png" />
                    <p>Exhaustive e-content/ printed material for in-depth reference</p>
                  </div>
                  <div className="col-6 col-lg-3">
                    <img src="/images/lm/LM7.png" />
                    <p>Self-study activities including assignments, quiz &amp; MCQs, essay-type questions, case study, etc.</p>
                  </div>
                  <div className="col-6 col-lg-3">
                    <img src="/images/lm/LM8.png" />
                    <p>Experiential learning methods including individual and group projects</p>
                  </div>
                </div>
              </div>
            </div>
