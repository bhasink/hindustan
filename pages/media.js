...
const Media = () => {
  ...
  const getAllBlogs = async () => {
    try {
      const { data } = await axios.get(`${process.env.NEXT_PUBLIC_API}/media`)

      const getMedia = data.data.get_media.data
              ...
              <option value="Year">Year</option>
                ...
                <div className="newshmbs">
                  <div className="row">
                    ...
                    {media &&
                      media.map((media_data, key) => (
                        <div className="col-lg-6 col-md-6">
                          <div className="crds">
                            <img src="/images/mediaic/1.jpg" />
                            <p>
                              {media_data.short_desc}

                              <Link
                                target="_blank"
                                href={media_data.external_url}
                              >
              ...
              >
                ...
                <div className="tab-content" id="myTabContent2">
                  ...
                  <div
                    ...
                    id="universitytb"
                    role="tabpanel"
                    aria-labelledby="universitytb-tab"
                  >
                    {/* <div className="sotfllshw">
                      <select
                        className="selectpicker"
                  ...
                  <div
                    ...
                    id="gallerytbs"
                    role="tabpanel"
                    aria-labelledby="gallerytbs-tab"
                  >
                    {/* <div className="sotfllshw">
                      <select
                        className="selectpicker"
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-7  text-center text-lg-left p-2">
                <h4>
                  Learn future-ready and industry-relevant skills and build a
                  promising career
                </h4>
              </div>
